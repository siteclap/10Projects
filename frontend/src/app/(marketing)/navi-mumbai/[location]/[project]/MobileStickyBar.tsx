...
export function MobileStickyBar({ projectTitle, projectUrl, ctaLabels }: MobileStickyBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white p-md shadow-sticky lg:hidden">
      <div className="flex items-center gap-sm">
        ...
        <a
          ...
          className={cn(
            'flex h-[44px] flex-1 items-center justify-center gap-xs rounded-sm font-medium text-white no-underline',
