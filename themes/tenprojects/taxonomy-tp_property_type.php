...
<main class="tp-category-page">
	...
	<div class="tp-container">
		...
		<div class="tp-category-header">
			<h1><?php echo esc_html( $term_name ); ?> Properties</h1>
			<p class="tp-category-count"><?php echo esc_html( $term_count ); ?> project<?php echo $term_count !== 1 ? 's' : ''; ?> found</p>
		</div>
				...
				?>
					<div class="tp-project-card">
						...
						<div class="tp-project-card__body">
							...
							<?php endif; ?>
							<?php if ( $p_stage ) : ?>
								<div class="tp-project-card__meta"><?php echo esc_html( $p_stage ); ?></div>
							<?php endif; ?>
						</div>
					</div>
				<?php endwhile; ?>
		...
		<?php else : ?>
			...
			<div class="tp-empty-state">
				...
				<h3>No <?php echo esc_html( $term_name ); ?> properties yet</h3>
